    ...
    <div class="modal-dialog modal-md modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-4">Current Image</div>
                    <div class="col-8">:  
                        @if ($existingImage)
                       
                            <img src="{{ asset('storage/' . $existingImage) }}" class="img-fluid"
                                style="max-height:70px" alt="{{ $name }}">
                        @else
            ...
            <div class="modal-footer">
                ...
                <button wire:click="update({{ $category_id }})" type="button" class="btn btn-warning btn-sm"><i
